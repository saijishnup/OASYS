...
(sender_id, receiver_id, origin, destination, weight_kg, status, tracking_number, shipping_cost)
VALUES
...
(20, 16, 'Surat',     'Nagpur',    18.20, 'in_transit', 'TRK100006', 1000.00),
(34, 35, 'Lucknow',   'Patna',      7.40, 'delivered',  'TRK100007', 1200.00);
-- ============================================================
-- ENERGY
-- ============================================================
...
(35, 'residential', 'MTR-006-RES', 'active'),
(22, 'commercial',  'MTR-007-COM', 'active');
...
('Mahindra XUV700',   'suv',      'petrol',  2100000.00,   6),
('Honda City e:HEV',  'sedan',    'hybrid',  1950000.00,   7),
('Ather 450X',        'bike',     'electric', 165000.00,  18),
('Tata Ace EV',       'truck',    'electric', 980000.00,   9),
('Kia Sonet',         'suv',      'diesel',  1450000.00,  11),
('Toyota Hilux',      'truck',    'diesel',  3750000.00,   4),
('TVS iQube',         'bike',     'electric', 155000.00,  22);
...
(30, 5, 'cancelled',         NULL),
(26, 2, 'confirmed', 1200000.00),
(27, 1, 'pending',          NULL),
(31, 6, 'confirmed', 2100000.00),
(32, 7, 'delivered', 1950000.00),
(33, 8, 'delivered',  165000.00),
(34, 9, 'confirmed',  980000.00),
(35,10, 'confirmed', 1450000.00),
(26,11, 'delivered', 3750000.00),
(27,12, 'confirmed',  155000.00),
(28, 6, 'pending',          NULL),
(29,10, 'delivered', 1450000.00),
(30, 8, 'cancelled',        NULL),
(31, 3, 'delivered', 1500000.00),
(32, 9, 'confirmed',  980000.00),
(33, 7, 'pending',          NULL),
(34,11, 'confirmed', 3750000.00),
(35,12, 'delivered',  155000.00);
...
(30, 2, 'Wheel Alignment',   '2025-04-26 15:00:00', 'pending'),
(26, 1, 'AC Service',        '2025-04-27 11:15:00', 'cancelled'),
(31, 6, 'Engine Diagnostics','2025-05-02 10:30:00', 'completed'),
(32, 7, 'Hybrid System Check','2025-05-03 12:00:00', 'pending'),
(33, 8, 'Software Update',   '2025-05-04 09:45:00', 'completed'),
(34, 9, 'Battery Inspection','2025-05-05 14:15:00', 'in_progress'),
(35,10, 'Brake Service',     '2025-05-06 11:00:00', 'pending'),
(26,11, 'Fleet Inspection',  '2025-05-07 16:00:00', 'pending'),
(27,12, 'Charging Port Check','2025-05-08 13:20:00', 'completed'),
(28, 3, 'Annual Service',    '2025-05-09 10:10:00', 'cancelled'),
(29, 6, 'Suspension Check',  '2025-05-10 15:30:00', 'pending'),
(30,10, 'Diesel Filter Swap','2025-05-11 09:00:00', 'completed'),
(31, 9, 'Tyre Rotation',     '2025-05-12 17:00:00', 'in_progress');
